      ...
      <div className={`pokemon-page pokemon-type-${type.name}`}>
        ...
        <div className="pokemon-info">
          ...
          <div className="pokemon-abilities">
            {normalAbility && <PokemonAbility abilityName={formatName(normalAbility.ability.name)} abilityType="Normal Ability" />}
            {hiddenAbility && <PokemonAbility abilityName={formatName(hiddenAbility.ability.name)} abilityType="Hidden Ability" />}
          </div>
        </div>
      </div>
    </>
